...
| 04 | **Couverture** | 1ère + 4ème de couverture générées à partir de **gabarits flat design** (les vôtres !) : palette, titre, accroche, texte de 4ème et bio rédigés par l'IA. Export JPG eBook + couverture complète imprimable (dos calculé, fond perdu, zone code-barres). |
| 05 | **Rédaction** | Écriture section par section par Gemini Pro, **avancement en direct** (%, mots, chapitre, temps restant), **journal en direct**, **points de contrôle en base** : toute coupure (réseau, quota, fermeture du navigateur) reprend exactement où elle s'est arrêtée, sans doublon. |
